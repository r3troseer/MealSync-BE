...
## Table of Contents
- [MealSync - AI-Powered Household Meal Planning Platform](#mealsync---ai-powered-household-meal-planning-platform)
  - [Table of Contents](#table-of-contents)
  - [Project Overview](#project-overview)
    - [Problem Statement](#problem-statement)
    - [Project Scope](#project-scope)
  - [Key Features Implemented](#key-features-implemented)
    - [🤖 AI-Powered Planning (Backend API)](#-ai-powered-planning-backend-api)
    - [🏠 Household Collaboration (Backend API)](#-household-collaboration-backend-api)
    - [📅 Meal Planning (Backend API)](#-meal-planning-backend-api)
    - [📖 Recipe Management (Backend API)](#-recipe-management-backend-api)
    - [🥕 Ingredient \& Inventory (Backend API)](#-ingredient--inventory-backend-api)
    - [🛒 Grocery Lists (Backend API)](#-grocery-lists-backend-api)
  ...
  - [System Architecture](#system-architecture)
    - [Architectural Pattern: Layered Architecture](#architectural-pattern-layered-architecture)
  ...
  - [API Endpoints](#api-endpoints)
    - [Authentication (6 endpoints)](#authentication-6-endpoints)
    - [AI Features (5 endpoints - Key Enhancements)](#ai-features-5-endpoints---key-enhancements)
    - [Recipes (7 endpoints)](#recipes-7-endpoints)
    - [Meals (11 endpoints)](#meals-11-endpoints)
    - [Households (10 endpoints)](#households-10-endpoints)
    - [Ingredients (6 endpoints)](#ingredients-6-endpoints)
    - [Grocery Lists (13 endpoints)](#grocery-lists-13-endpoints)
    - [User Management (7 endpoints)](#user-management-7-endpoints)
  - [Software Metrics \& Cost Estimation](#software-metrics--cost-estimation)
    - [COCOMO Model Estimation](#cocomo-model-estimation)
    - [Code Metrics (Verified)](#code-metrics-verified)
  - [Advanced Features Implemented](#advanced-features-implemented)
    - [1. AI-Powered Meal Plan Saving (Latest Enhancement)](#1-ai-powered-meal-plan-saving-latest-enhancement)
    - [2. Ingredient Fuzzy Matching](#2-ingredient-fuzzy-matching)
  ...
  - [Academic Context](#academic-context)
    - [Module: CN7021 - Advanced Software Engineering](#module-cn7021---advanced-software-engineering)
    - [Institution: University of East London](#institution-university-of-east-london)
    - [Assessment: Group Coursework (50%)](#assessment-group-coursework-50)
    - [Learning Outcomes Demonstrated](#learning-outcomes-demonstrated)
    - [Enhancements Over Base Project](#enhancements-over-base-project)
  - [Frontend Integration](#frontend-integration)
    - [Frontend-Backend Architecture](#frontend-backend-architecture)
    - [API Consumption Example (Frontend)](#api-consumption-example-frontend)
